...
const Companies = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-5 lg:px-8 pt-20 sm:pt-24 lg:pt-28 pb-10 space-y-5 sm:space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          ...
          <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-2xl shadow border flex items-center gap-3 sm:gap-4">
            <div className="p-2 sm:p-2.5 bg-purple-50 rounded-xl shrink-0">
              <Building2 className="text-[#6A38C2] w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <p className="text-gray-500 text-xs sm:text-sm">Total Companies</p>
              <h2 className="text-xl sm:text-2xl font-bold">{companies?.length || 0}</h2>
            </div>
          </div>

          <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-2xl shadow border flex items-center gap-3 sm:gap-4">
            <div className="p-2 sm:p-2.5 bg-purple-50 rounded-xl shrink-0">
              <Briefcase className="text-[#6A38C2] w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <p className="text-gray-500 text-xs sm:text-sm">Active Recruiters</p>
              <h2 className="text-xl sm:text-2xl font-bold">{companies?.length || 0}</h2>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          {/* Search + Filter — full width on mobile, fixed width on md+ */}
          <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 sm:w-auto md:w-[520px]">
            ...
            <div className="relative flex-1 group">
              ...
              <Input
                className="
                  pl-9 w-full rounded-xl text-sm
                  focus-visible:ring-2
                  focus-visible:ring-[#6A38C2]
                  focus-visible:ring-offset-2
                  transition-all duration-200
          ...
          {/* New Company button — full width on mobile, auto on sm+ */}
          <Button
            onClick={() => navigate("/admin/companies/create")}
            className="
              w-full sm:w-auto
        ...
        {/* ================= TABLE CARD ================= */}
        <div className="bg-white rounded-2xl shadow border p-4 sm:p-5 lg:p-6">
          <CompaniesTable companies={sortedCompanies} />
        </div>
